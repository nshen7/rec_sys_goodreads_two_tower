...
# Configuration: Using 20.0% sample data
# Data path: gs://nshen7-personal-bucket/projects/rec_sys_goodreads/data/splits_sample_20pct
# Model output: gs://nshen7-personal-bucket/projects/rec_sys_goodreads/models/als_sample_20pct
# Train: 30,338,675 interactions
# Val:   8,692,184 interactions
# Test:  4,417,042 interactions

# Popularity baseline Precision@10: 0.0215
# 26/02/25 03:09:17 WARN InstanceBuilder: Failed to load implementation from:dev.ludovic.netlib.blas.VectorBLAS
# [1/1] rank=50, regParam=0.1, maxIter=20, beta=0.5 ... NDCG@10=0.0195, P@10=0.0186 (2320s)

# Grid search complete.

#   Rank   RegParam  MaxIter   Beta    NDCG@10     P@10     R@10
# --------------------------------------------------------------
#     50      0.100       20    0.5     0.0195   0.0186   0.0195

# Best: rank=50, regParam=0.1, maxIter=20, beta=0.5
# Best Val NDCG@10: 0.0195

# Evaluating best model on test set...
#   Computing metrics for K=10...
#   Computing metrics for K=50...
#   Computing metrics for K=100...

# Model saved to: gs://nshen7-personal-bucket/projects/rec_sys_goodreads/models/als_sample_20pct/model
# Tuning results saved to: gs://nshen7-personal-bucket/projects/rec_sys_goodreads/models/als_sample_20pct/tuning_results
...
# Interaction strength: r = 1 + 2*is_read + 0.5*max(0, rating-3)
